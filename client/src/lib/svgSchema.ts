...
const SVG_ELEMENTS: SvgElementSchema[] = [
  {
    ...
    children: ["g", "rect", "circle", "ellipse", "line", "polyline", "polygon", "path", "text", "defs", ...GRAPHICAL_CHILDREN.filter((t) => t !== "g")],
  ...
  },
  {
    ...
    snippet: '<linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#3b82f6"/><stop offset="100%" stop-color="#8b5cf6"/></linearGradient>',
  },
  {
    tag: "use",
  ...
  },
  {
    ...
    children: [...GRAPHICAL_CHILDREN],
    snippet: '<symbol id="icon" viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" fill="#3b82f6"/></symbol>',
  },
  {
    tag: "linearGradient",
    commonAttributes: ["id", "x1", "y1", "x2", "y2", "gradientUnits"],
    attributes: ["id", "x1", "y1", "x2", "y2", "gradientUnits", "gradientTransform", "spreadMethod", "href", ...GLOBAL_ATTRIBUTES],
  ...
  },
  {
    ...
    attributes: ["id", "cx", "cy", "r", "fx", "fy", "gradientUnits", "gradientTransform", "spreadMethod", "href", ...GLOBAL_ATTRIBUTES],
    children: [...GRADIENT_CHILDREN],
    snippet: '<stop offset="0%" stop-color="#3b82f6"/>',
  },
  {
  ...
  },
  {
    ...
    attributes: ["id", "x", "y", "width", "height", "maskUnits", "maskContentUnits", ...GLOBAL_ATTRIBUTES],
    children: [...GRAPHICAL_CHILDREN],
  ...
  },
  {
    ...
    children: [],
    snippet: '<image href="" x="0" y="0" width="100" height="100" preserveAspectRatio="xMidYMid meet"/>',
  },
];
...
function applyViewBoxToSnippet(
  snippet: string,
  tagName: string,
  viewBox: ViewBox,
): string {
